...
const Navbar = (props) => {
    ...
    return (_jsxs(FlexBetween, { mb: "0.25rem", p: "0.5rem 0rem", color: palette.grey[300], children: [_jsxs(FlexBetween, { gap: "0.75rem", children: [_jsx(PixIcon, { sx: { fontSize: "28px" } }), _jsx(Typography, { variant: "h4", fontSize: "16px", children: "ML Your Buisness" })] }), _jsxs(FlexBetween, { gap: "2rem", children: [_jsx(Box, { sx: { "&:hover": { color: palette.primary[100] } }, children: _jsx(Link, { to: "/", onClick: () => setSelected("dashboard"), style: {
